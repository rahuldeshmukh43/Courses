...
#for i in range(4):
#    img1a=cv2.putText(imgcopy,pt_names[i],tuple(pts_temp[i]), font,5,(0,255,255),3,cv2.LINE_AA)
#    img1a=cv2.line(imgcopy,tuple(pts_temp[i]),tuple(pts_temp[i+1]),(0,0,255),10)

...
% x0 = [  0.350113005416948;...
%         8.217596212161899;...
%         -2.530475785010287];   % initial design
x0=[0;0;0];
...
while ((abs((f-f_last)/f_last) >= obj_tol) || (max(g) >= gj_tol))
    ...
    [xstar,phistar,exitflag,output,grad,hessian] = fminunc(@hw1SUMTphi,...
        x0,options,r_p);
...
%----------results----------------%
% cr =   0.802815467599828
% b =  13.999945706938167
% a =  0.876171575563591
% xstar is feasible
% f(xstar) =  99.974558740329954
% p=15 iterations

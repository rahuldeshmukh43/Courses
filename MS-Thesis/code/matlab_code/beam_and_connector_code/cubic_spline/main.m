...
parent_dir = uigetdir('/export/home/a/deshmuk5/abaqus/MWspring/beam_connector_model_runs/cubic_spline/');
...
% dia_max3=[141.3];%dia_max3=dia_max3*[(1-0.025/2),1,(1+0.025/2)];
% dia_max4=[142.7];%dia_max4=dia_max4*[(1-0.025/2),1,(1+0.025/2)];
% dia_max5=[130.95];%dia_max5=dia_max5*[(1+0.025/2)];%dia_max5=dia_max5*[(1-0.025/2),1,(1+0.025/2)];
% dia_max6=[95.8];
% dia_end=[92.7];
% 
% dia_min1=[93];
% dia_min2=[126.2];%dia_min2=dia_min2*[(1-0.025/2),1,(1+0.025/2)];
% dia_min3=[140.4];%dia_min3=dia_min3*[(1-0.025/2),1,(1+0.025/2)];
% dia_min4=[124.5];%dia_min4=dia_min4*[(1-0.025/2),1,(1+0.025/2)];
% dia_min5=[93.25];
% 
% angle_pts = [0 100 174 424 522 724 812 930 1105 1219 1461 1553 1643];%in degree
% height_pts= [0 0 0 24 38 83 100 125 164 177 196 196 196];% in mm
% height_pts= [height_pts;0 0 0 25 39 84 101 126 165 178 196 196 196];% in mm
% height_pts= [0 0.8950 0 24 38 83 101 125 164 177.8 196.7 195.3 196.5];% in mm
...
result = struct('wire_dia',{},'spring_height',{},'spring_max_radius',{},'spring_initial_radius',{},...%'pitchvar',{},'centervar',{},
...
save(matfilename,'result','keys','values','wire_dia',...
    'friction_spring_stiff_top','friction_spring_stiff_bottom',...
    'springyoungmodulus','radialspring_stiffness','radialspring_tension',...
    'dia_start','dia_max1','dia_max2','dia_max3','dia_max4','dia_max5','dia_max6','dia_end',...
    'dia_min1','dia_min2','dia_min3','dia_min4','dia_min5','angle_pts','height_pts');
                                                            ...
                                                            for ikrc=1:length(radialspring_stiffness)
                                                                for ikft=1:length(friction_spring_stiff_top)
                                                                    for ikfb = 1:length(friction_spring_stiff_bottom)
                                                                        ...
                                                                        fprintf(strcat('*** Starting \t',num2str(itotal),' iteration at \t',datestr(now),'***\n'));
                                                                        ...
                                                                        printreadme(filepath,wire_dia,itotal,...
                                                                            friction_spring_stiff_top(ikft),friction_spring_stiff_bottom(ikfb),...
                                                                        ...
                                                                        %(1a)
                                                                        %findXYZ
                                                                        [X,Y,Z,ID,spring_height,spring_max_radius,spring_initial_radius]=cubicspline_interpolate(filepath,N,dia_start(ids),dia_max1(idmx1),dia_max2(idmx2),dia_max3(idmx3),dia_max4(idmx4),dia_max5(idmx5),dia_max6(idmx6),dia_end(ide),...
                                                                            dia_min1(idmn1),dia_min2(idmn2),dia_min3(idmn3),dia_min4(idmn4),dia_min5(idmn5),angle_pts,height_pts(ih,:),wire_dia);
                                                                        %(1b)
                                                                        ...
                                                                        result(itotal).height_pts= height_pts(ih,:);
                                                                        ...
                                                                        values = 1:1:(itotal);
                                                                        keys{itotal} = strcat(num2str(ih),num2str(ids),num2str(idmx1),num2str(idmx2),num2str(idmx3),num2str(idmx4),num2str(idmx5),num2str(idmx6),num2str(ide),...
                                                                            num2str(idmn1),num2str(idmn2),num2str(idmn3),num2str(idmn4),num2str(idmn5),...
                                                                            num2str(iE),num2str(ikrt),num2str(ikrc),num2str(ikft),num2str(ikfb));
                                                                        
                                                                        fprintf('* Saving results *\n');
                                                                        save(matfilename,'result','values','keys','wire_dia',...
                                                                            'friction_spring_stiff_top','friction_spring_stiff_bottom',...
                                                                            'springyoungmodulus','radialspring_stiffness','radialspring_tension',...
                                                                            'dia_start','dia_max1','dia_max2','dia_max3','dia_max4','dia_max5','dia_max6','dia_end',...
                                                                            'dia_min1','dia_min2','dia_min3','dia_min4','dia_min5','angle_pts','height_pts');
...
list = {'height_pts','dia_start','dia_max1','dia_max2','dia_max3','dia_max4','dia_max5','dia_max6','dia_end',...
    'dia_min1','dia_min2','dia_min3','dia_min4','dia_min5',...
    'springyoungmodulus','radialspring_tension','radialspring_stiffness',...
    'friction_spring_stiff_top','friction_spring_stiff_bottom'};

save(matfilename,'result','dict','keys','values','wire_dia',...
    'friction_spring_stiff_top','friction_spring_stiff_bottom',...
    'springyoungmodulus','radialspring_stiffness','radialspring_tension',...
    'dia_start','dia_max1','dia_max2','dia_max3','dia_max4','dia_max5','dia_max6','dia_end',...

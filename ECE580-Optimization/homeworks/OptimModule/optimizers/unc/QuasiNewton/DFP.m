function [x_k, history_out] = DFP(x_k,fun,grad,...
                                verbose, TolFun, TolX, TolGrad)
    history.name = 'Quasi-Newton: DFP';
    switch nargin
        case 3
            verbose = 0;
            TolFun = 1e-4;
    ...
    while ~done
        ...
        delta_H_k1 = (delta_x_k*delta_x_k')/a_k;
        delta_H_k2 = ((H_k*delta_g_k)*(H_k*delta_g_k)')/(delta_g_k'*H_k*delta_g_k);

...
fprintf(fID,'\t\tdisplacement.append(abs(odbStep.frames[i].fieldOutputs[''U''].getSubset(region =odb_topcenter_region ).values[0].data[1]))#appending abs value of Uy of the top node ## note vlaues[0] says that we have only one node in this subset\n');
% 

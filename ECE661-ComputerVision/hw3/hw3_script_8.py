...
img1a=np.copy(imgcopy)
pt_names=['P','Q','S','R']
pts_temp=np.array([img1T,img1U,img1W,img1V,img1T])
font = cv2.FONT_HERSHEY_PLAIN
for i in range(4):
    cv2.putText(img1a,pt_names[i],tuple(pts_temp[i]), font,15,(0,255,255),20,cv2.LINE_AA)
    cv2.line(img1a,tuple(pts_temp[i]),tuple(pts_temp[i+1]),(0,0,255),15)
...
pts1=np.array([img1T,img1U,img1V,img1W,
               img1T,img1V,img1U,img1W])
...
pts1=np.array([img1T,img1V,img1V,img1W, 
...
pts1=np.array([img1T,img1U, img1U,img1W, img1U,img1W, img1W,img1V,
               img1W,img1V, img1V,img1T, img1V,img1T, img1T,img1U,
               img1P,img1S, img1R,img1Q,
               img1P,img1Q, img1Q,img1S])#good with d oc Cinf [  1.00594359e+00   9.93980919e-01   2.23030239e-11]

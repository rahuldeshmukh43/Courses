...
fprintf(fID,'springDisplacement=-175.00#mm\n');
...
fprintf(fID,'springAssembly.setElementType(regions=(springInstance.cells,),elemTypes=(elemType,))\n');
...
fprintf(fID,'\t\t-(spring_height+spring_coord[i][1]-spring_coord[0][1])),(-eps*(spring_coord[i][1]-spring_coord[0][1]),-(spring_coord[i][1]-spring_coord[0][1])),(0,0),\n');
...
fprintf(fID,'\t\t-(spring_height+(spring_coord[-1][1]-spring_coord[i][1]))),(-eps*(spring_coord[-1][1]-spring_coord[i][1]),-(spring_coord[-1][1]-spring_coord[i][1])),(0,0),\n');
fprintf(fID,'\t\t(eps*(10*spring_initial_radius),(10*spring_initial_radius))),components=(1,))\n');
fprintf(fID,'\n');
fprintf(fID,'\n');
